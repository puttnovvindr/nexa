...
export function useCrudHandler() {
  ...
  const handleAction = (promise: Promise<ActionResult>, successMsg: string, onSuccess?: () => void) => {
  ...
  const openDelete = (id: string | string[], action: (id: string | string[]) => Promise<ActionResult>, label?: string, validate?: () => boolean) => {
